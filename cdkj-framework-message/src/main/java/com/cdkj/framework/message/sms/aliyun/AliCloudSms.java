package com.cdkj.framework.message.sms.aliyun;
...
import com.cdkj.framework.config.SmsConfig;
import com.cdkj.framework.enums.AliCloudSmsEnum;
 ...
 * @Package: com.cdkj.framework.core.message.sms.aliyun
...
public class AliCloudSms {
    ...
    public static String sendSms(Map<String, String> content, String messageTemplate, String... phoneNumbers) throws ClientException {
        ...
        request.setOutId("com.cdkj.framework.sms");
