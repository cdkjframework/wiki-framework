package com.cdkj.framework.core.spring.interceptor;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.cdkj.framework.config.CustomConfig;
import com.cdkj.framework.config.InterceptorConfig;
import com.cdkj.framework.core.business.service.MongoService;
import com.cdkj.framework.core.business.service.OrderNumberService;
import com.cdkj.framework.core.spring.filter.HttpServletContentRequestWrapper;
...
public abstract class AbstractInterceptor implements IInterceptor {
    ...
    public void logRecord(HttpServletRequest httpServletRequest, UserEntity userEntity, String inString) {
        ...
        recordEntity.setAccountName(userEntity.getAccountName());
    ...
    public void addJsonObject(JSONObject jsonObject, UserEntity userEntity) {
        jsonObject.put("addAccountId", userEntity.getId());
        jsonObject.put("addAccountName", userEntity.getAccountName());
