...
public class ProducerConfiguration {
    ...
    public Map<String, Object> producerConfigs() {
        ...
        if (StringUtils.isNotNullAndEmpty(kafkaConfig.getUsername()) && StringUtils.isNotNullAndEmpty(kafkaConfig.getPassword())) {
            props.put(CommonClientConfigs.SECURITY_PROTOCOL_CONFIG, kafkaConfig.getProtocol());
            props.put(SaslConfigs.SASL_MECHANISM, kafkaConfig.getMechanism());
            props.put(SaslConfigs.SASL_JAAS_CONFIG, String.format(kafkaConfig.getJaasConfig(), kafkaConfig.getUsername(), kafkaConfig.getPassword()));
        }
