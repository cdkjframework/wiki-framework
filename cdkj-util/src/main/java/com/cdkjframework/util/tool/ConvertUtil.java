...
import static com.cdkjframework.util.tool.StringUtil.isNullAndSpaceOrEmpty;
...
public class ConvertUtil {
     ...
     * 日志
     */
    private static LogUtil logUtil = LogUtil.getLogger(ConvertUtil.class);
    ...
    private static boolean dataNumberType(Object obj) {
        ...
        //验证是否为数字
        return RegexUtil.isNumber(obj.toString());
    }
