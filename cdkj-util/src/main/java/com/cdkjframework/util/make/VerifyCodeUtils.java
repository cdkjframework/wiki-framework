...
public class VerifyCodeUtils {
    ...
    public static void outputImage(int w, int h, OutputStream os, String code) throws IOException {
        ...
        entity.setBackgroundColor(PicturesUtil.getRandColor(200, 250));
        entity.setFontColor(PicturesUtil.getRandColor(100, 160));
        entity.setLineColor(PicturesUtil.getRandColor(160, 200));
