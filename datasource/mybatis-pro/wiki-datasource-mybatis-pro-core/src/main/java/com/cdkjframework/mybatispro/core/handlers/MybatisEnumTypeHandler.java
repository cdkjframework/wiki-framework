...
import com.cdkjframework.mybatispro.core.annotation.EnumValue;
import com.cdkjframework.mybatispro.core.annotation.IEnum;
...
public final class MybatisEnumTypeHandler<E extends Enum<E>> extends BaseTypeHandler<E> {
  ...
  public MybatisEnumTypeHandler(Class<E> enumClassType) {
    ...
    this.propertyType = ReflectionUtils.resolvePrimitiveIfNecessary(metaClass.getGetterType(name));
  ...
  public static Optional<String> findEnumValueFieldName(Class<?> clazz) {
    if (clazz != null && clazz.isEnum()) {
      ...
      return Optional.ofNullable(CollectUtils.computeIfAbsent(TABLE_METHOD_OF_ENUM_TYPES, className, key -> {
  ...
  private Object getValue(Object object) {
    try {
      ...
      throw new GlobalRuntimeException(e, e.getMessage());
    }
  }
}
