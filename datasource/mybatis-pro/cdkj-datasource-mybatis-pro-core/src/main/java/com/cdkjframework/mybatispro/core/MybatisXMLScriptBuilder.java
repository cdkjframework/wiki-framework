 ...
 * @Package: com.cdkjframework.mybatispro.core
 * @ClassName: MybatisXMLScriptBuilder
 * @Description: <p>试验性功能,解决mybatis堆内存过大的问题(看后期mybatis官方会不会解决堆内存占用问题)</p>
...
public class MybatisXMLScriptBuilder extends BaseBuilder {
  ...
  private static final StaticTextSqlNode SPACE_SQL_NODE = new StaticTextSqlNode(StringUtils.SPACE);
