...
public class ClassUtils {
  ...
  public static Class<?> getUserClass(Object object) {
    AssertUtils.isEmptyMessage(object, "Instance must not be null");
  ...
  public static <T> T newInstance(Class<T> clazz) {
    try {
      ...
      throw new GlobalRuntimeException("实例化对象时出现错误,请尝试给 %s 添加无参的构造方法", e);
    }
  }
  ...
  public static Class<?> toClassConfident(String name, ClassLoader classLoader) {
    try {
      ...
      throw new GlobalRuntimeException("找不到指定的class！请仅在明确确定会有 class 的时候，调用该方法", e);
    }
  }
  ...
  public static String getPackageName(String fqClassName) {
    AssertUtils.isEmptyMessage(fqClassName, "Class name must not be null");
    int lastDotIndex = fqClassName.lastIndexOf(StringUtils.DOT);
