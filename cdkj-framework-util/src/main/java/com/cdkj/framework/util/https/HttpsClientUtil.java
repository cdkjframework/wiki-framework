package com.cdkj.framework.util.https;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.cdkj.framework.consts.HttpHeaderConstant;
import com.cdkj.framework.entity.http.HttpRequestEntity;
import com.cdkj.framework.util.http.HttpRequestUtil;
import com.cdkj.framework.util.log.LogUtil;
import com.cdkj.framework.util.tool.GzipUtil;
 ...
 * @Package: com.cdkj.framework.core.util.https
...
public class HttpsClientUtil {
     ...
     * 日志
     */
    private static LogUtil logUtil = LogUtil.getLogger(HttpsClientUtil.class);
    ...
    public static String doPost(HttpRequestEntity requestEntity) {
        ...
        try {
            ...
            if (StringUtil.isNullAndSpaceOrEmpty(basicHeader)) {
            ...
            if (requestEntity.isCompress()) {
                basicHeader = "gzip";
                String gzipParams = GzipUtil.gZip(param, requestEntity.getCharset());
    ...
    public static StringBuilder httpsRequest(HttpRequestEntity requestEntity) {
        ...
        try {
            ...
            //设置套接工厂
            connection.setSSLSocketFactory(httpClient.ctx.getSocketFactory());

            // 设置通用的请求属性
            //设置 http 请求头
            HttpRequestUtil.setHeader(connection, requestEntity);
