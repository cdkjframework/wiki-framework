package com.cdkj.framework.util.make;
 ...
 * @Package: com.cdkj.framework.core.util.make
...
public class VerifyCodeUtil {
    ...
    public static String outputVerifyImage(int w, int h, File outputFile, int verifySize) throws IOException {
        String verifyCode = GeneratedValueUtil.getRandomCharacter(verifySize);
    ...
    public static void main(String[] args) throws IOException {
        ...
        String verifyCode = GeneratedValueUtil.getRandomCharacter(4);
