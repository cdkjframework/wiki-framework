package com.cdkj.framework.util.images.pictures;

import com.cdkj.framework.entity.file.ImageEntity;
 ...
 * @Package: com.cdkj.framework.core.util.images.pictures
...
public class PicturesUtil {
     ...
     * 日志
     */
    private static LogUtil logUtil = LogUtil.getLogger(PicturesUtil.class);
