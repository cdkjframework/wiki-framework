...
public abstract class AServerInfos {
     ...
     * 日志
     */
    private final LogUtils logUtils = LogUtils.getLogger(AServerInfos.class);
    ...
    public LicenseExtraEntity getServerInfos() {
        LicenseExtraEntity result = new LicenseExtraEntity();
        try {
            initServerInfos();
    ...
    public List<String> getIpAddress() throws Exception {
        ...
        if (StringUtils.isNotNullAndEmpty(inetAddresses)) {
