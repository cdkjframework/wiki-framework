...
public class RedisUtils {
  ...
  public static boolean syncExpire(String key, long time) {
    ...
    try {
      ...
      RedisFuture<Boolean> redisFuture = redisAsyncCommands == null ? commands.expire(key, time) : redisAsyncCommands.expire(key, time);
  ...
  public static boolean sisMember(String key, String value) {
    key = getNamespaces(key);
    try {
      RedisFuture<Boolean> redisFuture = redisAsyncCommands == null ? commands.sismember(key, value) : redisAsyncCommands.sismember(key, value);
      return redisFuture.get();
    } catch (Exception e) {
      logUtils.error(e.getStackTrace(), e.getMessage());
      return false;
  ...
  public static long sadd(String key, String value) {
    key = getNamespaces(key);
    try {
      RedisFuture<Long> redisFuture = redisAsyncCommands == null ? commands.sadd(key, value) : redisAsyncCommands.sadd(key, value);
  ...
  public static long srem(String key, String value) {
    key = getNamespaces(key);
    try {
      RedisFuture<Long> redisFuture = redisAsyncCommands == null ? commands.srem(key, value) : redisAsyncCommands.srem(key, value);
      return redisFuture.get();
    } catch (Exception e) {
      logUtils.error(e.getStackTrace(), e.getMessage());
      return IntegerConsts.ZERO;
  ...
  public static boolean syncExists(String... keys) {
    ...
    RedisFuture<Long> redisFuture = redisAsyncCommands == null ? commands.exists(keyList) : redisAsyncCommands.exists(keyList);
    try {
  ...
  public static String hGet(String key, String value) {
    ...
    RedisFuture<String> redisFuture = redisAsyncCommands == null ? commands.hget(key, value) : redisAsyncCommands.hget(key, value);
    try {
      return redisFuture.get();
    } catch (InterruptedException e) {
      logUtils.error(e.getStackTrace(), e.getMessage());
  ...
  public static boolean hSet(String key, String field, String value) {
    key = getNamespaces(key);
    RedisFuture<Boolean> redisFuture = redisAsyncCommands == null ? commands.hset(key, field, value) : redisAsyncCommands.hset(key, field, value);
    try {
      return redisFuture.get();
    } catch (InterruptedException e) {
      logUtils.error(e.getStackTrace(), e.getMessage());
  ...
  public static Long hDel(String key, String field) {
    key = getNamespaces(key);
    RedisFuture<Long> redisFuture = redisAsyncCommands == null ? commands.hdel(key, field) : redisAsyncCommands.hdel(key, field);
    try {
      return redisFuture.get();
    } catch (InterruptedException e) {
      logUtils.error(e.getStackTrace(), e.getMessage());
  ...
  public static Long syncAppend(String key, String value) {
    ...
    RedisFuture<Long> redisFuture = redisAsyncCommands == null ? commands.append(key, value) : redisAsyncCommands.append(key, value);
    try {
      return redisFuture.get();
    } catch (InterruptedException e) {
      logUtils.error(e.getStackTrace(), e.getMessage());
  ...
  public static List<String> hvals(String key) {
    ...
    RedisFuture<List<String>> redisFuture = redisAsyncCommands == null ? commands.hvals(key) : redisAsyncCommands.hvals(key);
    try {
      return redisFuture.get();
    } catch (InterruptedException e) {
      logUtils.error(e.getStackTrace(), e.getMessage());
  ...
  public static String syncGet(String key) {
    key = getNamespaces(key);
    RedisFuture<String> redisFuture = redisAsyncCommands == null ? commands.get(key) : redisAsyncCommands.get(key);
    try {
      return redisFuture.get();
    } catch (InterruptedException e) {
      logUtils.error(e.getStackTrace(), e.getMessage());
  ...
  public static Map<String, String> hGetAll(String key, String value) {
    ...
    RedisFuture<Map<String, String>> redisFuture = redisAsyncCommands == null ? commands.hgetall(key) : redisAsyncCommands.hgetall(key);
    try {
      return redisFuture.get();
    } catch (InterruptedException e) {
      logUtils.error(e.getStackTrace(), e.getMessage());
